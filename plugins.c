...
static DB_functions_t deadbeef_api = {
    ...
    .md5_append =
        (void (*)(DB_md5_t *s, const uint8_t *daya, int nbytes))md5_append,
    ...
    .streamer_get_playing_track =
        (DB_playItem_t * (*)(void)) streamer_get_playing_track,
    .streamer_get_streaming_track =
        (DB_playItem_t * (*)(void)) streamer_get_streaming_track,
    ...
    .plt_load = (DB_playItem_t * (*)(ddb_playlist_t * plt, DB_playItem_t *after,
                                     const char *fname, int *pabort,
                                     int (*cb)(DB_playItem_t *it, void *data),
                                     void *user_data)) plt_load,
    .plt_save = (int (*)(ddb_playlist_t *plt, DB_playItem_t *first,
    ...
    .plt_get_title =
        (int (*)(ddb_playlist_t *handle, char *buffer, int sz))plt_get_title,
    .plt_set_title =
        (int (*)(ddb_playlist_t *handle, const char *buffer))plt_set_title,
    .plt_modified = (void (*)(ddb_playlist_t *handle))plt_modified,
    .plt_get_modification_idx =
        (int (*)(ddb_playlist_t *handle))plt_get_modification_idx,
    .plt_get_item_idx = (int (*)(ddb_playlist_t *plt, DB_playItem_t *it,
                                 int iter))plt_get_item_idx,

    // playlist metadata
    .plt_add_meta = (void (*)(ddb_playlist_t *handle, const char *key,
                              const char *value))plt_add_meta,
    .plt_replace_meta = (void (*)(ddb_playlist_t *handle, const char *key,
                                  const char *value))plt_replace_meta,
    .plt_append_meta = (void (*)(ddb_playlist_t *handle, const char *key,
                                 const char *value))plt_append_meta,
    .plt_set_meta_int = (void (*)(ddb_playlist_t *handle, const char *key,
                                  int value))plt_set_meta_int,
    .plt_set_meta_float = (void (*)(ddb_playlist_t *handle, const char *key,
                                    float value))plt_set_meta_float,
    .plt_find_meta =
        (const char *(*)(ddb_playlist_t *handle, const char *key))plt_find_meta,
    .plt_get_metadata_head =
        (DB_metaInfo_t * (*)(ddb_playlist_t * handle)) plt_get_metadata_head,
    .plt_delete_metadata = (void (*)(ddb_playlist_t *handle,
                                     DB_metaInfo_t *meta))plt_delete_metadata,
    .plt_find_meta_int = (int (*)(ddb_playlist_t *handle, const char *key,
                                  int def))plt_find_meta_int,
    .plt_find_meta_float = (float (*)(ddb_playlist_t *handle, const char *key,
                                      float def))plt_find_meta_float,
    .plt_delete_all_meta =
        (void (*)(ddb_playlist_t *handle))plt_delete_all_meta,

    // operating on playlist items
    .plt_insert_item =
        (DB_playItem_t * (*)(ddb_playlist_t * playlist, DB_playItem_t *after,
                             DB_playItem_t *it)) plt_insert_item,
    .plt_insert_file =
        (DB_playItem_t * (*)(ddb_playlist_t * playlist, DB_playItem_t *after,
                             const char *fname, int *pabort,
                             int (*cb)(DB_playItem_t *it, void *data),
    ...
    .plt_insert_dir =
        (DB_playItem_t * (*)(ddb_playlist_t * plt, DB_playItem_t *after,
                             const char *dirname, int *pabort,
                             int (*cb)(DB_playItem_t *it, void *data),
                             void *user_data)) plt_insert_dir,
    .plt_set_item_duration = (void (*)(ddb_playlist_t *plt, DB_playItem_t *it,
                                       float duration))plt_set_item_duration,
    .plt_remove_item =
        (int (*)(ddb_playlist_t *playlist, DB_playItem_t *it))plt_remove_item,
    ...
    .pl_item_alloc_init =
        (DB_playItem_t * (*)(const char *fname, const char *decoder_id))
            pl_item_alloc_init,
    ...
    .plt_add_file =
        (int (*)(ddb_playlist_t *plt, const char *,
                 int (*cb)(DB_playItem_t *it, void *data), void *))plt_add_file,
    .plt_add_dir = (int (*)(ddb_playlist_t *plt, const char *dirname,
                            int (*cb)(DB_playItem_t *it, void *data),
                            void *user_data))plt_add_dir,
    ...
    .pl_get_idx_of_iter =
        (int (*)(DB_playItem_t *it, int iter))pl_get_idx_of_iter,
    .pl_get_for_idx = (DB_playItem_t * (*)(int)) pl_get_for_idx,
    .pl_get_for_idx_and_iter =
        (DB_playItem_t * (*)(int idx, int iter)) pl_get_for_idx_and_iter,
    ...
    .pl_set_item_flags =
        (void (*)(DB_playItem_t *it, uint32_t flags))pl_set_item_flags,
    .plt_sort = (void (*)(ddb_playlist_t *plt, int iter, int id,
                          const char *format, int order))plt_sort,
    .pl_items_copy_junk = (void (*)(DB_playItem_t *from, DB_playItem_t *first,
                                    DB_playItem_t *last))pl_items_copy_junk,
    .pl_set_item_replaygain = (void (*)(DB_playItem_t *it, int idx,
                                        float value))pl_set_item_replaygain,
    .pl_get_item_replaygain =
        (float (*)(DB_playItem_t *it, int idx))pl_get_item_replaygain,
    .plt_get_totaltime = (float (*)(ddb_playlist_t *plt))plt_get_totaltime,
    .plt_get_item_for_idx =
        (DB_playItem_t * (*)(ddb_playlist_t * playlist, int idx, int iter))
            plt_get_item_for_idx,
    .pl_get_totaltime = pl_get_totaltime,
    .pl_getcount = pl_getcount,
    .plt_get_item_count =
        (int (*)(ddb_playlist_t *plt, int iter))plt_get_item_count,
    .plt_delete_selected = (int (*)(ddb_playlist_t *plt))plt_delete_selected,
    .pl_delete_selected = pl_delete_selected,
    .plt_set_cursor =
        (void (*)(ddb_playlist_t *plt, int iter, int cursor))plt_set_cursor,
    ...
    .plt_get_first =
        (DB_playItem_t * (*)(ddb_playlist_t * plt, int)) plt_get_first,
    .pl_get_first = (DB_playItem_t * (*)(int)) pl_get_first,
    .plt_get_last =
        (DB_playItem_t * (*)(ddb_playlist_t * plt, int)) plt_get_last,
    ...
    .pl_format_title = (int (*)(DB_playItem_t *it, int idx, char *s, int size,
                                int id, const char *fmt))pl_format_title,
    .pl_format_title_escaped =
        (int (*)(DB_playItem_t *it, int idx, char *s, int size, int id,
                 const char *fmt))pl_format_title_escaped,
    .pl_format_time = pl_format_time,
    .plt_move_items =
        (void (*)(ddb_playlist_t *to, int iter, ddb_playlist_t *from,
                  DB_playItem_t *drop_before, uint32_t *indexes,
                  int count))plt_move_items,
    .plt_copy_items = (void (*)(ddb_playlist_t *to, int iter,
                                ddb_playlist_t *from, DB_playItem_t *before,
                                uint32_t *indices, int cnt))plt_copy_items,
    .plt_search_reset = (void (*)(ddb_playlist_t *plt))plt_search_reset,
    .plt_search_process =
        (void (*)(ddb_playlist_t *plt, const char *t))plt_search_process,
    .pl_get_playlist =
        (ddb_playlist_t * (*)(DB_playItem_t * it)) pl_get_playlist,
    // metainfo
    .pl_add_meta =
        (void (*)(DB_playItem_t *, const char *, const char *))pl_add_meta,
    .pl_append_meta =
        (void (*)(DB_playItem_t *, const char *, const char *))pl_append_meta,
    .pl_set_meta_int = (void (*)(DB_playItem_t *it, const char *key,
                                 int value))pl_set_meta_int,
    .pl_set_meta_float = (void (*)(DB_playItem_t *it, const char *key,
                                   float value))pl_set_meta_float,
    .pl_delete_meta =
        (void (*)(DB_playItem_t *, const char *key))pl_delete_meta,
    .pl_find_meta =
        (const char *(*)(DB_playItem_t *, const char *))pl_find_meta,
    .pl_find_meta_int =
        (int (*)(DB_playItem_t *it, const char *key, int def))pl_find_meta_int,
    .pl_find_meta_float = (float (*)(DB_playItem_t *it, const char *key,
                                     float def))pl_find_meta_float,
    .pl_replace_meta =
        (void (*)(DB_playItem_t *, const char *, const char *))pl_replace_meta,
    .pl_delete_all_meta = (void (*)(DB_playItem_t *it))pl_delete_all_meta,
    .pl_get_metadata_head =
        (DB_metaInfo_t * (*)(DB_playItem_t * it)) pl_get_metadata_head,
    .pl_delete_metadata =
        (void (*)(DB_playItem_t *, DB_metaInfo_t *))pl_delete_metadata,
    // cuesheet support
    .plt_insert_cue_from_buffer =
        (DB_playItem_t * (*)(ddb_playlist_t * plt, DB_playItem_t *after,
                             DB_playItem_t *origin, const uint8_t *buffer,
                             int buffersize, int numsamples, int samplerate))
            plt_insert_cue_from_buffer,
    .plt_insert_cue =
        (DB_playItem_t * (*)(ddb_playlist_t * plt, DB_playItem_t *after,
                             DB_playItem_t *origin, int numsamples,
                             int samplerate)) plt_insert_cue,
    // playqueue support
    ...
    .junk_id3v1_write =
        (int (*)(FILE *, DB_playItem_t *, const char *))junk_id3v1_write,
    .junk_id3v2_find = junk_id3v2_find,
    .junk_id3v2_read = (int (*)(DB_playItem_t *it, DB_FILE *fp))junk_id3v2_read,
    .junk_id3v2_read_full = (int (*)(DB_playItem_t *, DB_id3v2_tag_t *tag,
                                     DB_FILE *fp))junk_id3v2_read_full,
    ...
    .junk_apev2_read_mem =
        (int (*)(DB_playItem_t *it, char *mem, int size))junk_apev2_read_mem,
    .junk_apev2_read_full =
        (int (*)(DB_playItem_t *it, DB_apev2_tag_t *tag_store,
                 DB_FILE *fp))junk_apev2_read_full,
    .junk_apev2_read_full_mem =
        (int (*)(DB_playItem_t *it, DB_apev2_tag_t *tag_store, char *mem,
                 int memsize))junk_apev2_read_full_mem,
    ...
    .junk_rewrite_tags =
        (int (*)(DB_playItem_t *it, uint32_t flags, int id3v2_version,
                 const char *id3v1_encoding))junk_rewrite_tags,
    // vfs
    .fopen = vfs_fopen,
    .fclose = vfs_fclose,
    .fread = vfs_fread,
    ...
    .plt_set_fast_mode =
        (void (*)(ddb_playlist_t *plt, int fast))plt_set_fast_mode,
    ...
    .pl_find_meta_raw =
        (const char *(*)(DB_playItem_t *it, const char *key))pl_find_meta_raw,
    // ******* new 1.3 APIs ********
    .streamer_dsp_chain_save = streamer_dsp_chain_save,
    // ******* new 1.4 APIs ********
    .pl_get_meta = (int (*)(DB_playItem_t *it, const char *key, char *val,
                            int size))pl_get_meta,
    .pl_get_meta_raw = (int (*)(DB_playItem_t *it, const char *key, char *val,
                                int size))pl_get_meta_raw,
    .plt_get_meta = (int (*)(ddb_playlist_t *handle, const char *key, char *val,
                             int size))plt_get_meta,
    .pl_meta_exists =
        (int (*)(DB_playItem_t *it, const char *key))pl_meta_exists,
    // ******* new 1.5 APIs ********
    ...
    .plt_load2 = (DB_playItem_t *
                  (*)(int visibility, ddb_playlist_t *plt,
                      ddb_playItem_t *after, const char *fname, int *pabort,
                      int (*callback)(DB_playItem_t *it, void *user_data),
                      void *user_data)) plt_load2,
    .plt_add_file2 =
        (int (*)(int visibility, ddb_playlist_t *plt, const char *fname,
                 int (*callback)(DB_playItem_t *it, void *user_data),
                 void *user_data))plt_add_file2,
    .plt_add_dir2 =
        (int (*)(int visibility, ddb_playlist_t *plt, const char *dirname,
                 int (*callback)(DB_playItem_t *it, void *user_data),
    ...
    .plt_add_files_begin =
        (int (*)(ddb_playlist_t *plt, int visibility))plt_add_files_begin,
    .plt_add_files_end =
        (void (*)(ddb_playlist_t *plt, int visibility))plt_add_files_end,
    ...
    .plt_sort_v2 = (void (*)(ddb_playlist_t *plt, int iter, int id,
                             const char *format, int order))plt_sort_v2,
    ...
    .playqueue_insert_at =
        (void (*)(int n, DB_playItem_t *it))playqueue_insert_at,
    ...
    .plt_search_process2 = (void (*)(ddb_playlist_t *plt, const char *text,
                                     int select_results))plt_search_process2,
    .plt_process_cue =
        (DB_playItem_t * (*)(ddb_playlist_t * plt, DB_playItem_t *after,
                             DB_playItem_t *it, uint64_t numsamples,
                             int samplerate)) plt_process_cue,
    .pl_meta_for_key = (DB_metaInfo_t * (*)(DB_playItem_t * it,
                                            const char *key)) pl_meta_for_key,
    ...
    .replaygain_init_settings =
        (void (*)(ddb_replaygain_settings_t *settings,
                  DB_playItem_t *it))replaygain_init_settings,

    .sort_track_array =
        (void (*)(ddb_playlist_t *playlist, DB_playItem_t **tracks,
                  int num_tracks, const char *format,
                  int order))sort_track_array,

    .pl_item_init = (DB_playItem_t * (*)(const char *fname)) pl_item_init,

    .pl_item_get_startsample =
        (int64_t(*)(DB_playItem_t * it)) pl_item_get_startsample,
    .pl_item_get_endsample =
        (int64_t(*)(DB_playItem_t * it)) pl_item_get_endsample,
    .pl_item_set_startsample =
        (void (*)(DB_playItem_t *it, int64_t sample))pl_item_set_startsample,
    .pl_item_set_endsample =
        (void (*)(DB_playItem_t *it, int64_t sample))pl_item_set_endsample,

    .plt_get_selection_playback_time =
        (float (*)(ddb_playlist_t *plt))plt_get_selection_playback_time,
    ...
    .pl_meta_for_key_with_override =
        (DB_metaInfo_t * (*)(ddb_playItem_t * it, const char *key))
            pl_meta_for_key_with_override,
    .pl_find_meta_with_override =
        (const char *(*)(ddb_playItem_t *it,
                         const char *key))pl_find_meta_with_override,
    .pl_get_meta_with_override =
        (int (*)(ddb_playItem_t *it, const char *key, char *val,
                 size_t size))pl_get_meta_with_override,
    .pl_meta_exists_with_override = (int (*)(
        ddb_playItem_t *it, const char *key))pl_meta_exists_with_override,

    .plt_item_set_selected = (void (*)(ddb_playlist_t *plt, ddb_playItem_t *it,
                                       int sel))pl_set_selected_in_playlist,
    .plt_find_by_name =
        (ddb_playlist_t * (*)(const char *name)) plt_find_by_name,
    .plt_append = (ddb_playlist_t * (*)(const char *title)) plt_append,

    .plt_get_head_item =
        (ddb_playItem_t * (*)(ddb_playlist_t * p, int iter)) plt_get_head_item,
    .plt_get_tail_item =
        (ddb_playItem_t * (*)(ddb_playlist_t * p, int iter)) plt_get_tail_item,
};

DB_functions_t *deadbeef = &deadbeef_api;

const char *plug_get_config_dir(void) { return dbconfdir; }

const char *plug_get_prefix(void) { return dbinstalldir; }

const char *plug_get_doc_dir(void) { return dbdocdir; }

const char *plug_get_plugin_dir(void) { return dbplugindir; }

const char *plug_get_pixmap_dir(void) { return dbpixmapdir; }

const char *plug_get_system_dir(int dir_id) {
  switch (dir_id) {
...
void plug_volume_set_db(float db) {
  volume_set_db(db);
  messagepump_push(DB_EV_VOLUMECHANGED, 0, 0, 0);
}

void plug_volume_set_amp(float amp) {
  volume_set_amp(amp);
  messagepump_push(DB_EV_VOLUMECHANGED, 0, 0, 0);
}

void plug_md5(uint8_t sig[16], const char *in, int len) {
  md5_state_t st;
  md5_init(&st);
...
void plug_md5_to_str(char *str, const uint8_t sig[16]) {
  int i = 0;
...
float plug_playback_get_pos(void) {
...
void plug_playback_set_pos(float pos) {
  playItem_t *trk = streamer_get_playing_track();
  float dur = trk ? pl_get_item_duration(trk) : -1;
  if (!trk || dur <= 0) {
    if (trk) {
...
int plug_init_plugin(DB_plugin_t *(*loadfunc)(DB_functions_t *), void *handle) {
  ...
  for (plugin_t *p = plugins; p; prev = p, p = p->next) {
    int same_id = p->plugin->id && plugin_api->id &&
                  !strcmp(p->plugin->id, plugin_api->id);
    int same_name = (!p->plugin->id || !plugin_api->id) && p->plugin->name &&
                    plugin_api->name &&
    ...
    if (same_id || same_name) {
      if (plugin_api->version_major > p->plugin->version_major ||
        ...
        trace_err("found copy of plugin \"%s\" (%s), but newer version is "
                  "already loaded\n",
  ...
  if (plugin_api->api_vmajor != 0 || plugin_api->api_vminor != 0) {
    ...
    if (DB_API_VERSION_MAJOR != 9 || DB_API_VERSION_MINOR != 9) {
      if (plugin_api->api_vmajor != DB_API_VERSION_MAJOR ||
          plugin_api->api_vminor > DB_API_VERSION_MINOR) {
        trace_err("WARNING: plugin \"%s\" wants API v%d.%d (got %d.%d), will "
                  "not be loaded\n",
                  plugin_api->name, plugin_api->api_vmajor,
                  plugin_api->api_vminor, DB_API_VERSION_MAJOR,
                  DB_API_VERSION_MINOR);
        return -1;
      }
    }
  } else {
    trace_err("WARNING: plugin \"%s\" has disabled version check. please don't "
              "distribute it!\n",
              plugin_api->name);
  }
#endif
...
void plug_remove_plugin(void *p) {
  int i;
  for (i = 0; g_plugins[i]; i++) {
    if (g_plugins[i] == p) {
      memmove(&g_plugins[i], &g_plugins[i + 1],
              (MAX_PLUGINS + 1 - i - 1) * sizeof(void *));
    }
  }
  for (i = 0; g_decoder_plugins[i]; i++) {
    if (g_decoder_plugins[i] == p) {
      memmove(&g_decoder_plugins[i], &g_decoder_plugins[i + 1],
  ...
  for (i = 0; g_vfs_plugins[i]; i++) {
    if (g_vfs_plugins[i] == p) {
      memmove(&g_vfs_plugins[i], &g_vfs_plugins[i + 1],
              (MAX_VFS_PLUGINS + 1 - i - 1) * sizeof(void *));
      break;
    }
  }
  for (i = 0; g_dsp_plugins[i]; i++) {
    if (g_dsp_plugins[i] == p) {
      memmove(&g_dsp_plugins[i], &g_dsp_plugins[i + 1],
              (MAX_DSP_PLUGINS + 1 - i - 1) * sizeof(void *));
      break;
    }
  }
  for (i = 0; g_output_plugins[i]; i++) {
    if (g_output_plugins[i] == p) {
      memmove(&g_output_plugins[i], &g_output_plugins[i + 1],
  ...
  for (i = 0; g_playlist_plugins[i]; i++) {
    if (g_playlist_plugins[i] == p) {
      memmove(&g_playlist_plugins[i], &g_playlist_plugins[i + 1],
...
static int load_plugin(const char *plugdir, char *d_name, int l) {
...
static int load_gui_plugin(const char **plugdirs) {
  ...
  trace("selected GUI plugin not found or failed to load, trying to find "
        "another GUI plugin\n");
...
static int load_plugin_dir(const char *plugdir, int gui_scan) {
  int n = 0;
  char conf_blacklist_plugins[1000];
  conf_get_str("blacklist_plugins", "", conf_blacklist_plugins,
               sizeof(conf_blacklist_plugins));
  if (gui_scan) {
  ...
  if (n < 0) {
    ...
    for (i = 0; i < n; i++) {
      ...
      while (namelist[i]->d_name[0] != '.'
        ...
        if (strcasecmp(namelist[i]->d_name + l - sizeof(PLUGINEXT) + 1,
                       PLUGINEXT)) {
          break;
        }
        char d_name[256];
...
int plug_load_all(void) {
  ...
  if (!res) {
    strncat(libpath, "/Deadbeef/Plugins",
            sizeof(libpath) - strlen(libpath) - 1);
  }
  ...
  if (xdg_local_home) {
    ...
    if (!homedir) {
      ...
      int written = snprintf(xdg_plugin_dir, sizeof(xdg_plugin_dir),
                             LOCAL_PLUGINS_DIR, homedir);
      if (written > sizeof(xdg_plugin_dir)) {
        trace_err("warning: XDG_LOCAL_HOME value is too long: %s. Ignoring.",
                  xdg_local_home);
        xdg_plugin_dir[0] = 0;
      }
#ifdef __x86_64__
...
#define ARCH_BITS (int)(sizeof(long) * 8)
#endif
      written = snprintf(xdg_plugin_dir_explicit_arch,
                         sizeof(xdg_plugin_dir_explicit_arch),
                         LOCAL_ARCH_PLUGINS_DIR, homedir, ARCH_BITS);
  ...
  const char *plugins_dirs[] = {xdg_plugin_dir_explicit_arch, xdg_plugin_dir,
                                dirname, NULL};
  ...
  strncpy(plugin_path, conf_get_str_fast("android.plugin_path", ""),
          sizeof(plugin_path) - 1);
...
const char **plug_get_gui_names(void) { return (const char **)g_gui_names; }

DB_output_t *plug_get_output(void) { return output_plugin; }

static DB_output_t *_select_output_plugin(void) {
#ifndef ANDROID
...
void plug_free_decoder_ids(void) {
  int i;
  for (i = 0; i < MAX_DECODER_PLUGINS; i++) {
    if (decoder_ids[i]) {
      free(decoder_ids[i]);
...
DB_decoder_t *plug_get_decoder_for_id(const char *id) {
  if (!id) {
    return NULL;
  }
...
int plug_is_local_file(const char *fname) {
  ...
  for (; *f; f++) {
    ...
    if (!strncmp(f, "://", 3)) {
      ...
      for (int i = 0; plug[i]; i++) {
        if (plug[i]->get_schemes && plug[i]->is_streaming &&
            plug[i]->is_streaming()) {
...
int is_relative_path_posix(const char *path_or_url) {
  // file url?
...
int is_relative_path_win32(const char *path_or_url) {
  // file url?
  if (!strncasecmp(path_or_url, "file://", 7)) {
    path_or_url += 7;
  } else {
  ...
  // NOTE: this test won't cover \\? relative path and absolute path starting
  // with "\"
  if (strlen(path_or_url) >= 3) {
    if (isalpha(path_or_url[0]) && path_or_url[1] == ':' &&
        (path_or_url[2] == '\\' || path_or_url[2] == '/')) {
      return 0;
    } else if ((path_or_url[0] == '\\' && path_or_url[1] == '\\') ||
               (path_or_url[0] == '/' && path_or_url[1] == '/')) {
      return 0;
    }
  }
  return 1;
...
#ifndef _WIN32
int is_relative_path(const char *path_or_url) {
...
int have_background_jobs(void) { return num_background_jobs; }
...
// for tests
void plug_register_in(DB_plugin_t *inplug) {
  int i;
  for (i = 0; g_plugins[i]; i++)
    ;
  g_plugins[i++] = inplug;
...
// for tests
void plug_register_out(DB_plugin_t *outplug) {
  int i;
  for (i = 0; g_plugins[i]; i++)
    ;
  g_plugins[i++] = outplug;
...
// for tests
DB_functions_t *plug_get_api(void) { return &deadbeef_api; }
