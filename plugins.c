...
const char *plug_get_config_dir(void) {
    return dbconfdir;
}

const char *plug_get_prefix(void) {
    return dbinstalldir;
}

const char *plug_get_doc_dir(void) {
    return dbdocdir;
}

const char *plug_get_plugin_dir(void) {
    return dbplugindir;
}

const char *plug_get_pixmap_dir(void) {
    return dbpixmapdir;
}
...
DB_output_t *plug_get_output(void) {
...
// for tests
DB_functions_t *plug_get_api(void) {
    return &deadbeef_api;
}
