...
+ (ScriptableTableDataSource *)dataSourceWithScriptable:
...
- (ScriptableTableDataSource *)initWithScriptable:
    (scriptableItem_t *_Nullable)scriptable NS_DESIGNATED_INITIALIZER;
