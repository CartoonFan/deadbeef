...
GtkWidget *create_mainwin(void) {
    ...
    order_linear =
        gtk_radio_menu_item_new_with_mnemonic(order_linear_group, _("Off"));
    order_linear_group =
        gtk_radio_menu_item_get_group(GTK_RADIO_MENU_ITEM(order_linear));
    ...
    order_shuffle =
        gtk_radio_menu_item_new_with_mnemonic(order_linear_group, _("Tracks"));
    order_linear_group =
        gtk_radio_menu_item_get_group(GTK_RADIO_MENU_ITEM(order_shuffle));
    ...
    order_shuffle_albums =
        gtk_radio_menu_item_new_with_mnemonic(order_linear_group, _("Albums"));
    order_linear_group =
        gtk_radio_menu_item_get_group(GTK_RADIO_MENU_ITEM(order_shuffle_albums));
    gtk_widget_show(order_shuffle_albums);
    gtk_container_add(GTK_CONTAINER(Order_menu), order_shuffle_albums);
    gtk_check_menu_item_set_active(GTK_CHECK_MENU_ITEM(order_shuffle_albums),
                                   TRUE);

    order_random = gtk_radio_menu_item_new_with_mnemonic(order_linear_group,
                   _("Random Tracks"));
    order_linear_group =
        gtk_radio_menu_item_get_group(GTK_RADIO_MENU_ITEM(order_random));
    ...
    loop_all =
        gtk_radio_menu_item_new_with_mnemonic(loop_all_group, _("All Tracks"));
    ...
    loop_single =
        gtk_radio_menu_item_new_with_mnemonic(loop_all_group, _("One Track"));
    loop_all_group =
        gtk_radio_menu_item_get_group(GTK_RADIO_MENU_ITEM(loop_single));
    ...
    loop_disable =
        gtk_radio_menu_item_new_with_mnemonic(loop_all_group, _("Off"));
    loop_all_group =
        gtk_radio_menu_item_get_group(GTK_RADIO_MENU_ITEM(loop_disable));
    ...
    scroll_follows_playback =
        gtk_check_menu_item_new_with_mnemonic(_("Scroll follows playback"));
    gtk_widget_show(scroll_follows_playback);
    gtk_container_add(GTK_CONTAINER(Playback_menu), scroll_follows_playback);
    gtk_check_menu_item_set_active(GTK_CHECK_MENU_ITEM(scroll_follows_playback),
                                   TRUE);

    cursor_follows_playback =
        gtk_check_menu_item_new_with_mnemonic(_("Cursor follows playback"));
    gtk_widget_show(cursor_follows_playback);
    gtk_container_add(GTK_CONTAINER(Playback_menu), cursor_follows_playback);

    stop_after_current =
        gtk_check_menu_item_new_with_mnemonic(_("Stop after current track"));
    gtk_widget_show(stop_after_current);
    gtk_container_add(GTK_CONTAINER(Playback_menu), stop_after_current);

    stop_after_album =
        gtk_check_menu_item_new_with_mnemonic(_("Stop after current album"));
    ...
    jump_to_current_track1 =
        gtk_menu_item_new_with_mnemonic(_("Jump to current track"));
    ...
    g_signal_connect_after((gpointer)mainwin, "key_press_event",
                           G_CALLBACK(on_mainwin_key_press_event), NULL);
    g_signal_connect((gpointer)mainwin, "delete_event",
                     G_CALLBACK(on_mainwin_delete_event), NULL);
    g_signal_connect((gpointer)mainwin, "configure_event",
                     G_CALLBACK(on_mainwin_configure_event), NULL);
    g_signal_connect((gpointer)mainwin, "window_state_event",
                     G_CALLBACK(on_mainwin_window_state_event), NULL);
    g_signal_connect((gpointer)mainwin, "realize", G_CALLBACK(on_mainwin_realize),
                     NULL);
    g_signal_connect((gpointer)mainwin, "button_press_event",
                     G_CALLBACK(on_mainwin_button_press_event), NULL);
    g_signal_connect((gpointer)open, "activate", G_CALLBACK(on_open_activate),
                     NULL);
    g_signal_connect((gpointer)add_files, "activate",
                     G_CALLBACK(on_add_files_activate), NULL);
    g_signal_connect((gpointer)add_folders, "activate",
                     G_CALLBACK(on_add_folders_activate), NULL);
    g_signal_connect((gpointer)add_location1, "activate",
                     G_CALLBACK(on_add_location_activate), NULL);
    g_signal_connect((gpointer)new_playlist1, "activate",
                     G_CALLBACK(on_new_playlist1_activate), NULL);
    g_signal_connect((gpointer)playlist_load, "activate",
                     G_CALLBACK(on_playlist_load_activate), NULL);
    g_signal_connect((gpointer)playlist_save_as, "activate",
                     G_CALLBACK(on_playlist_save_as_activate), NULL);
    g_signal_connect((gpointer)quit, "activate", G_CALLBACK(on_quit_activate),
                     NULL);
    g_signal_connect((gpointer)clear1, "activate", G_CALLBACK(on_clear1_activate),
                     NULL);
    g_signal_connect((gpointer)select_all1, "activate",
                     G_CALLBACK(on_select_all1_activate), NULL);
    g_signal_connect((gpointer)deselect_all1, "activate",
                     G_CALLBACK(on_deselect_all1_activate), NULL);
    g_signal_connect((gpointer)invert_selection1, "activate",
                     G_CALLBACK(on_invert_selection1_activate), NULL);
    g_signal_connect((gpointer)remove1, "activate",
                     G_CALLBACK(on_remove1_activate), NULL);
    g_signal_connect((gpointer)crop1, "activate", G_CALLBACK(on_crop1_activate),
                     NULL);
    g_signal_connect((gpointer)find1, "activate", G_CALLBACK(on_find_activate),
                     NULL);
    g_signal_connect((gpointer)title1, "activate",
                     G_CALLBACK(on_sort_by_title_activate), NULL);
    g_signal_connect((gpointer)track_nr1, "activate",
                     G_CALLBACK(on_sort_by_track_nr_activate), NULL);
    g_signal_connect((gpointer)album1, "activate",
                     G_CALLBACK(on_sort_by_album_activate), NULL);
    g_signal_connect((gpointer)artist1, "activate",
                     G_CALLBACK(on_sort_by_artist_activate), NULL);
    g_signal_connect((gpointer)date1, "activate",
                     G_CALLBACK(on_sort_by_date_activate), NULL);
    g_signal_connect((gpointer)random1, "activate",
                     G_CALLBACK(on_sort_by_random_activate), NULL);
    g_signal_connect((gpointer)custom2, "activate",
                     G_CALLBACK(on_sort_by_custom_activate), NULL);
    ...
    g_signal_connect((gpointer)view_status_bar, "activate",
                     G_CALLBACK(on_toggle_status_bar_activate), NULL);
    g_signal_connect((gpointer)view_eq, "activate", G_CALLBACK(on_toggle_eq),
                     NULL);
    g_signal_connect((gpointer)design_mode1, "activate",
                     G_CALLBACK(on_design_mode1_activate), NULL);
    g_signal_connect((gpointer)view_log, "activate",
                     G_CALLBACK(on_view_log_activate), NULL);
    g_signal_connect((gpointer)order_linear, "activate",
                     G_CALLBACK(on_order_linear_activate), NULL);
    g_signal_connect((gpointer)order_shuffle, "activate",
                     G_CALLBACK(on_order_shuffle_activate), NULL);
    g_signal_connect((gpointer)order_shuffle_albums, "activate",
                     G_CALLBACK(on_order_shuffle_albums_activate), NULL);
    g_signal_connect((gpointer)order_random, "activate",
                     G_CALLBACK(on_order_random_activate), NULL);
    g_signal_connect((gpointer)loop_all, "activate",
                     G_CALLBACK(on_loop_all_activate), NULL);
    g_signal_connect((gpointer)loop_single, "activate",
                     G_CALLBACK(on_loop_single_activate), NULL);
    g_signal_connect((gpointer)loop_disable, "activate",
                     G_CALLBACK(on_loop_disable_activate), NULL);
    g_signal_connect((gpointer)scroll_follows_playback, "activate",
                     G_CALLBACK(on_scroll_follows_playback_activate), NULL);
    g_signal_connect((gpointer)cursor_follows_playback, "activate",
                     G_CALLBACK(on_cursor_follows_playback_activate), NULL);
    g_signal_connect((gpointer)stop_after_current, "activate",
                     G_CALLBACK(on_stop_after_current_activate), NULL);
    g_signal_connect((gpointer)stop_after_album, "activate",
                     G_CALLBACK(on_stop_after_album_activate), NULL);
    g_signal_connect((gpointer)jump_to_current_track1, "activate",
                     G_CALLBACK(on_jump_to_current_track1_activate), NULL);
    g_signal_connect((gpointer)help1, "activate", G_CALLBACK(on_help1_activate),
                     NULL);
    g_signal_connect((gpointer)changelog1, "activate",
                     G_CALLBACK(on_changelog1_activate), NULL);
    g_signal_connect((gpointer)gpl1, "activate", G_CALLBACK(on_gpl1_activate),
                     NULL);
    g_signal_connect((gpointer)lgpl1, "activate", G_CALLBACK(on_lgpl1_activate),
                     NULL);
    g_signal_connect((gpointer)about1, "activate", G_CALLBACK(on_about1_activate),
                     NULL);
    g_signal_connect((gpointer)translators1, "activate",
                     G_CALLBACK(on_translators1_activate), NULL);
    ...
    GLADE_HOOKUP_OBJECT(mainwin, scroll_follows_playback,
                        "scroll_follows_playback");
    GLADE_HOOKUP_OBJECT(mainwin, cursor_follows_playback,
                        "cursor_follows_playback");
    ...
    GLADE_HOOKUP_OBJECT(mainwin, jump_to_current_track1,
                        "jump_to_current_track1");
...
GtkWidget *create_searchwin(void) {
    ...
    g_signal_connect((gpointer)searchwin, "configure_event",
                     G_CALLBACK(on_searchwin_configure_event), NULL);
    g_signal_connect((gpointer)searchwin, "window_state_event",
                     G_CALLBACK(on_searchwin_window_state_event), NULL);
    g_signal_connect((gpointer)searchwin, "key_press_event",
                     G_CALLBACK(on_searchwin_key_press_event), NULL);
    g_signal_connect((gpointer)searchentry, "changed",
                     G_CALLBACK(on_searchentry_changed), NULL);
...
GtkWidget *create_traymenu(void) {
    ...
    g_signal_connect((gpointer)stop2, "activate", G_CALLBACK(on_stopbtn_clicked),
                     NULL);
    g_signal_connect((gpointer)play2, "activate", G_CALLBACK(on_playbtn_clicked),
                     NULL);
    g_signal_connect((gpointer)pause2, "activate",
                     G_CALLBACK(on_pausebtn_clicked), NULL);
    g_signal_connect((gpointer)previous2, "activate",
                     G_CALLBACK(on_prevbtn_clicked), NULL);
    g_signal_connect((gpointer)next2, "activate", G_CALLBACK(on_nextbtn_clicked),
                     NULL);
    g_signal_connect((gpointer)play_random1, "activate",
                     G_CALLBACK(on_playrand_clicked), NULL);
    g_signal_connect((gpointer)about3, "activate", G_CALLBACK(on_about1_activate),
                     NULL);
    g_signal_connect((gpointer)quit, "activate", G_CALLBACK(on_quit_activate),
                     NULL);
...
GtkWidget *create_progressdlg(void) {
    ...
    gtk_window_set_position(GTK_WINDOW(progressdlg),
    ...
    gtk_window_set_type_hint(GTK_WINDOW(progressdlg),
...
GtkWidget *create_helpwindow(void) {
    ...
    g_signal_connect((gpointer)helpwindow, "key_press_event",
                     G_CALLBACK(on_helpwindow_key_press_event), NULL);
...
GtkWidget *create_trackproperties(void) {
    ...
    gtk_scrolled_window_set_policy(GTK_SCROLLED_WINDOW(scrolledwindow6),
                                   GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
    gtk_scrolled_window_set_shadow_type(GTK_SCROLLED_WINDOW(scrolledwindow6),
                                        GTK_SHADOW_IN);
    ...
    gtk_notebook_set_tab_label(
        GTK_NOTEBOOK(notebook3),
        gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook3), 1), label80);

    g_signal_connect((gpointer)trackproperties, "key_press_event",
                     G_CALLBACK(on_trackproperties_key_press_event), NULL);
    g_signal_connect((gpointer)trackproperties, "delete_event",
                     G_CALLBACK(on_trackproperties_delete_event), NULL);
    g_signal_connect((gpointer)trackproperties, "configure_event",
                     G_CALLBACK(on_trackproperties_configure_event), NULL);
    g_signal_connect((gpointer)trackproperties, "window_state_event",
                     G_CALLBACK(on_trackproperties_window_state_event), NULL);
    g_signal_connect((gpointer)metalist, "button_press_event",
                     G_CALLBACK(on_metalist_button_press_event), NULL);
    g_signal_connect((gpointer)settings, "clicked",
                     G_CALLBACK(on_tagwriter_settings_clicked), NULL);
    g_signal_connect((gpointer)write_tags, "clicked",
                     G_CALLBACK(on_write_tags_clicked), NULL);
    ...
    /* Store pointers to all widgets, for use by lookup_widget(). */
    GLADE_HOOKUP_OBJECT_NO_REF(trackproperties, trackproperties,
                               "trackproperties");
...
GtkWidget *create_editcolumndlg(void) {
    ...
    gtk_window_set_type_hint(GTK_WINDOW(editcolumndlg),
                             GDK_WINDOW_TYPE_HINT_DIALOG);
    ...
    title_formatting_help_link = title_formatting_help_link_create(
                                     "title_formatting_help_link", "", "", 0, 0);
    gtk_widget_show(title_formatting_help_link);
    gtk_box_pack_start(GTK_BOX(hbox74), title_formatting_help_link, FALSE, TRUE,
                       0);
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(editcolumndlg), cancelbutton1,
                                 GTK_RESPONSE_CANCEL);
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(editcolumndlg), okbutton1,
                                 GTK_RESPONSE_OK);
    ...
    g_signal_connect((gpointer)title, "changed",
                     G_CALLBACK(on_editcolumn_title_changed), NULL);
    g_signal_connect((gpointer)id, "changed", G_CALLBACK(on_column_id_changed),
                     NULL);
    ...
    GLADE_HOOKUP_OBJECT(editcolumndlg, title_formatting_help_link,
                        "title_formatting_help_link");
    ...
    GLADE_HOOKUP_OBJECT_NO_REF(editcolumndlg, dialog_action_area1,
                               "dialog_action_area1");
...
GtkWidget *create_prefwin(void) {
    ...
    convert8to16 = gtk_check_button_new_with_mnemonic(
                       _("Always convert 8 bit audio to 16 bit"));
    gtk_widget_show(convert8to16);
    gtk_box_pack_start(GTK_BOX(vbox10), convert8to16, FALSE, FALSE, 0);

    convert16to24 = gtk_check_button_new_with_mnemonic(
                        _("Always convert 16 bit audio to 24 bit"));
    ...
    gtk_box_pack_start(GTK_BOX(hbox145), comboboxentry_direct_sr, FALSE, FALSE,
                       0);
    ...
    label_sr_mult_48 =
        gtk_label_new(_("For multiples of 48KHz (96K, 192K, ...):"));
    ...
    gtk_box_pack_start(GTK_BOX(hbox147), comboboxentry_sr_mult_48, FALSE, FALSE,
                       0);
    ...
    label_sr_mult_44 =
        gtk_label_new(_("For multiples of 44.1KHz (88.2K, 176.4K, ...):"));
    ...
    gtk_box_pack_start(GTK_BOX(hbox148), comboboxentry_sr_mult_44, FALSE, FALSE,
                       0);
    ...
    checkbutton_dependent_sr =
        gtk_check_button_new_with_mnemonic(_("Based on input samplerate"));
    gtk_widget_show(checkbutton_dependent_sr);
    gtk_frame_set_label_widget(GTK_FRAME(frame16), checkbutton_dependent_sr);

    checkbutton_sr_override =
        gtk_check_button_new_with_mnemonic(_("Override samplerate"));
    ...
    gtk_notebook_set_tab_label(
        ...
        gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook), 0), Sound);
    ...
    gtk_box_pack_start(GTK_BOX(hbox10), pref_replaygain_source_mode, TRUE, TRUE,
                       0);
    gtk_widget_set_size_request(pref_replaygain_source_mode, 337, -1);
    gtk_combo_box_text_append_text(
        GTK_COMBO_BOX_TEXT(pref_replaygain_source_mode), _("By playback order"));
    gtk_combo_box_text_append_text(
        GTK_COMBO_BOX_TEXT(pref_replaygain_source_mode), _("Track"));
    gtk_combo_box_text_append_text(
        GTK_COMBO_BOX_TEXT(pref_replaygain_source_mode), _("Album"));
    ...
    gtk_box_pack_start(GTK_BOX(hbox139), pref_replaygain_processing, TRUE, TRUE,
                       0);
    gtk_widget_set_size_request(pref_replaygain_processing, 337, -1);
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(pref_replaygain_processing),
                                   _("None"));
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(pref_replaygain_processing),
                                   _("Apply gain"));
    gtk_combo_box_text_append_text(
        GTK_COMBO_BOX_TEXT(pref_replaygain_processing),
        _("Apply gain and prevent clipping according to peak"));
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(pref_replaygain_processing),
                                   _("Only prevent clipping"));
    ...
    replaygain_preamp =
        gtk_hscale_new(GTK_ADJUSTMENT(gtk_adjustment_new(0, -12, 12, 0, 0, 0)));
    ...
    cli_add_to_playlist = gtk_check_button_new_with_mnemonic(
                              _("Add files from command line (or file manager) to this playlist:"));
    ...
    resume_last_session = gtk_check_button_new_with_mnemonic(
                              _("Resume previous session on startup"));
    gtk_widget_show(resume_last_session);
    gtk_box_pack_start(GTK_BOX(vbox8), resume_last_session, FALSE, FALSE, 0);

    ignore_archives = gtk_check_button_new_with_mnemonic(
                          _("Don't add from archives when adding folders"));
    gtk_widget_show(ignore_archives);
    gtk_box_pack_start(GTK_BOX(vbox8), ignore_archives, FALSE, FALSE, 0);

    reset_autostop = gtk_check_button_new_with_mnemonic(_(
    ...
    reset_autostopalbum = gtk_check_button_new_with_mnemonic(_(
    ...
    gtk_notebook_set_tab_label(
        GTK_NOTEBOOK(notebook),
        gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook), 1), label39);
    ...
    gtk_notebook_set_tab_label(
        GTK_NOTEBOOK(notebook),
        gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook), 2), label110);
    ...
    minimize_on_startup =
        gtk_check_button_new_with_mnemonic(_("Minimize to tray on startup"));
    gtk_widget_show(minimize_on_startup);
    gtk_box_pack_start(GTK_BOX(vbox9), minimize_on_startup, FALSE, FALSE, 0);

    pref_close_send_to_tray =
        gtk_check_button_new_with_mnemonic(_("Close minimizes to tray"));
    gtk_widget_show(pref_close_send_to_tray);
    gtk_box_pack_start(GTK_BOX(vbox9), pref_close_send_to_tray, FALSE, FALSE, 0);

    hide_tray_icon =
        gtk_check_button_new_with_mnemonic(_("Hide system tray icon"));
    gtk_widget_show(hide_tray_icon);
    gtk_box_pack_start(GTK_BOX(vbox9), hide_tray_icon, FALSE, FALSE, 0);

    move_to_trash = gtk_check_button_new_with_mnemonic(
                        _("Delete from disk should use Trash"));
    gtk_widget_show(move_to_trash);
    gtk_box_pack_start(GTK_BOX(vbox9), move_to_trash, FALSE, FALSE, 0);

    enable_shift_jis_recoding = gtk_check_button_new_with_mnemonic(
                                    _("Enable Japanese SHIFT-JIS detection and recoding"));
    gtk_widget_show(enable_shift_jis_recoding);
    gtk_box_pack_start(GTK_BOX(vbox9), enable_shift_jis_recoding, FALSE, FALSE,
                       0);

    enable_cp1251_recoding = gtk_check_button_new_with_mnemonic(
    ...
    enable_cp936_recoding = gtk_check_button_new_with_mnemonic(
                                _("Enable Chinese CP936 detection and recoding"));
    ...
    gui_fps =
        gtk_hscale_new(GTK_ADJUSTMENT(gtk_adjustment_new(10, 1, 30, 0, 0, 0)));
    ...
    display_seltime = gtk_check_button_new_with_mnemonic(
                          _("Display selection playback time in status bar"));
    ...
    gtk_notebook_set_tab_label(
        ...
        gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook5), 0), label147);
    ...
    mmb_delete_playlist = gtk_check_button_new_with_mnemonic(
    ...
    hide_delete_from_disk = gtk_check_button_new_with_mnemonic(
                                _("Hide \"Remove From Disk\" context menu item"));
    gtk_widget_show(hide_delete_from_disk);
    gtk_box_pack_start(GTK_BOX(vbox44), hide_delete_from_disk, FALSE, FALSE, 0);

    skip_deleted_songs = gtk_check_button_new_with_mnemonic(
                             _("Switch to the next song when the currently played one is removed from "
                               "disk"));
    gtk_widget_show(skip_deleted_songs);
    gtk_box_pack_start(GTK_BOX(vbox44), skip_deleted_songs, FALSE, FALSE, 0);

    auto_name_playlist_from_folder = gtk_check_button_new_with_mnemonic(
                                         _("Auto-name playlists when adding a single folder"));
    gtk_widget_show(auto_name_playlist_from_folder);
    gtk_box_pack_start(GTK_BOX(vbox44), auto_name_playlist_from_folder, FALSE,
                       FALSE, 0);

    auto_size_columns = gtk_check_button_new_with_mnemonic(
                            _("Auto-resize columns to fit the window"));
    ...
    listview_group_spacing_adj =
        G_OBJECT(gtk_adjustment_new(0, 0, 1000, 1, 10, 10));
    listview_group_spacing =
        gtk_spin_button_new(GTK_ADJUSTMENT(listview_group_spacing_adj), 1, 0);
    ...
    gtk_notebook_set_tab_label(
        GTK_NOTEBOOK(notebook5),
        gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook5), 1), label148);
    ...
    gtk_notebook_set_tab_label(
        GTK_NOTEBOOK(notebook4),
        gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook4), 0), label73);
    ...
    gtk_box_pack_start(GTK_BOX(vbox22), override_tabstrip_colors, FALSE, FALSE,
                       0);
    ...
    gtk_table_attach(GTK_TABLE(tabstrip_colors_group), tabstrip_selected_text, 1,
                     2, 2, 3, (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0),
                     0, 0);
    ...
    gtk_box_pack_start(GTK_BOX(hbox136), tabstrip_playing_italic, FALSE, FALSE,
                       0);
    ...
    gtk_box_pack_start(GTK_BOX(hbox137), tabstrip_selected_italic, FALSE, FALSE,
                       0);

    tabstrip_text_font = gtk_font_button_new();
    gtk_widget_show(tabstrip_text_font);
    gtk_table_attach(GTK_TABLE(tabstrip_colors_group), tabstrip_text_font, 2, 3,
    ...
    gtk_table_attach(GTK_TABLE(tabstrip_colors_group), tabstrip_playing_text, 1,
                     2, 1, 2, (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0),
                     0, 0);
    ...
    gtk_notebook_set_tab_label(
        GTK_NOTEBOOK(notebook4),
        gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook4), 1), label74);
    ...
    gtk_box_pack_start(GTK_BOX(listview_colors_group), vseparator1, FALSE, TRUE,
                       5);
    ...
    override_listview_colors = gtk_check_button_new_with_mnemonic(
                                   _("Override (loses GTK treeview theming, but speeds up rendering)"));
    ...
    gtk_notebook_set_tab_label(
        GTK_NOTEBOOK(notebook4),
        gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook4), 2), label75);

    label100 = gtk_label_new(_("Appearance"));
    gtk_widget_show(label100);
    gtk_notebook_set_tab_label(
        GTK_NOTEBOOK(notebook),
        gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook), 4), label100);
    ...
    pref_network_enableproxy =
        gtk_check_button_new_with_mnemonic(_("Enable Proxy Server"));
    gtk_widget_show(pref_network_enableproxy);
    gtk_box_pack_start(GTK_BOX(vbox11), pref_network_enableproxy, FALSE, FALSE,
                       0);
    ...
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(pref_network_proxytype),
                                   "HTTP");
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(pref_network_proxytype),
                                   "HTTP_1_0");
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(pref_network_proxytype),
    ...
    edit_content_type_mapping =
        gtk_button_new_with_mnemonic(_("Edit Content-Type Mapping"));
    gtk_widget_show(edit_content_type_mapping);
    gtk_box_pack_start(GTK_BOX(vbox11), edit_content_type_mapping, FALSE, FALSE,
                       0);
    ...
    gtk_notebook_set_tab_label(
        GTK_NOTEBOOK(notebook),
        gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook), 5), label16);
    ...
    label145 =
        gtk_label_new(_("Use the Apply button to save your changes,\nor the "
    ...
    image638 =
        gtk_image_new_from_stock("gtk-revert-to-saved", GTK_ICON_SIZE_BUTTON);
    ...
    gtk_notebook_set_tab_label(
        GTK_NOTEBOOK(notebook),
        gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook), 6), label132);
    ...
    gtk_notebook_set_tab_label(
        GTK_NOTEBOOK(notebook),
        gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook), 7), label3);
    ...
    GLADE_HOOKUP_OBJECT(prefwin, comboboxentry_direct_sr,
                        "comboboxentry_direct_sr");
    ...
    GLADE_HOOKUP_OBJECT(prefwin, comboboxentry_sr_mult_48,
                        "comboboxentry_sr_mult_48");
    GLADE_HOOKUP_OBJECT(prefwin, hbox148, "hbox148");
    GLADE_HOOKUP_OBJECT(prefwin, label_sr_mult_44, "label_sr_mult_44");
    GLADE_HOOKUP_OBJECT(prefwin, comboboxentry_sr_mult_44,
                        "comboboxentry_sr_mult_44");
    GLADE_HOOKUP_OBJECT(prefwin, checkbutton_dependent_sr,
                        "checkbutton_dependent_sr");
    GLADE_HOOKUP_OBJECT(prefwin, checkbutton_sr_override,
                        "checkbutton_sr_override");
    ...
    GLADE_HOOKUP_OBJECT(prefwin, pref_replaygain_source_mode,
                        "pref_replaygain_source_mode");
    GLADE_HOOKUP_OBJECT(prefwin, hbox139, "hbox139");
    GLADE_HOOKUP_OBJECT(prefwin, label163, "label163");
    GLADE_HOOKUP_OBJECT(prefwin, pref_replaygain_processing,
                        "pref_replaygain_processing");
    ...
    GLADE_HOOKUP_OBJECT(prefwin, pref_close_send_to_tray,
                        "pref_close_send_to_tray");
    GLADE_HOOKUP_OBJECT(prefwin, hide_tray_icon, "hide_tray_icon");
    GLADE_HOOKUP_OBJECT(prefwin, move_to_trash, "move_to_trash");
    GLADE_HOOKUP_OBJECT(prefwin, enable_shift_jis_recoding,
                        "enable_shift_jis_recoding");
    GLADE_HOOKUP_OBJECT(prefwin, enable_cp1251_recoding,
                        "enable_cp1251_recoding");
    ...
    GLADE_HOOKUP_OBJECT(prefwin, titlebar_format_playing,
                        "titlebar_format_playing");
    GLADE_HOOKUP_OBJECT(prefwin, hbox65, "hbox65");
    GLADE_HOOKUP_OBJECT(prefwin, label102, "label102");
    GLADE_HOOKUP_OBJECT(prefwin, titlebar_format_stopped,
                        "titlebar_format_stopped");
    ...
    GLADE_HOOKUP_OBJECT(prefwin, auto_name_playlist_from_folder,
    ...
    GLADE_HOOKUP_OBJECT(prefwin, listview_group_spacing,
                        "listview_group_spacing");
    ...
    GLADE_HOOKUP_OBJECT(prefwin, override_tabstrip_colors,
    ...
    GLADE_HOOKUP_OBJECT(prefwin, tabstrip_selected_text,
                        "tabstrip_selected_text");
    GLADE_HOOKUP_OBJECT(prefwin, hbox136, "hbox136");
    GLADE_HOOKUP_OBJECT(prefwin, tabstrip_playing_bold, "tabstrip_playing_bold");
    GLADE_HOOKUP_OBJECT(prefwin, tabstrip_playing_italic,
                        "tabstrip_playing_italic");
    GLADE_HOOKUP_OBJECT(prefwin, hbox137, "hbox137");
    GLADE_HOOKUP_OBJECT(prefwin, tabstrip_selected_bold,
                        "tabstrip_selected_bold");
    GLADE_HOOKUP_OBJECT(prefwin, tabstrip_selected_italic,
    ...
    GLADE_HOOKUP_OBJECT(prefwin, listview_selected_text,
    ...
    GLADE_HOOKUP_OBJECT(prefwin, listview_column_text_font,
                        "listview_column_text_font");
    GLADE_HOOKUP_OBJECT(prefwin, label149, "label149");
    GLADE_HOOKUP_OBJECT(prefwin, listview_group_text, "listview_group_text");
    GLADE_HOOKUP_OBJECT(prefwin, listview_group_text_font,
                        "listview_group_text_font");
    ...
    GLADE_HOOKUP_OBJECT(prefwin, override_listview_colors,
    ...
    GLADE_HOOKUP_OBJECT(prefwin, listview_playing_text_bold,
                        "listview_playing_text_bold");
    GLADE_HOOKUP_OBJECT(prefwin, listview_selected_text_bold,
                        "listview_selected_text_bold");
    GLADE_HOOKUP_OBJECT(prefwin, listview_playing_text_italic,
                        "listview_playing_text_italic");
    GLADE_HOOKUP_OBJECT(prefwin, listview_selected_text_italic,
                        "listview_selected_text_italic");
    ...
    GLADE_HOOKUP_OBJECT(prefwin, edit_content_type_mapping,
                        "edit_content_type_mapping");
    ...
    GLADE_HOOKUP_OBJECT_NO_REF(prefwin, dialog_action_area2,
                               "dialog_action_area2");
...
GtkWidget *create_entrydialog(void) {
    ...
    gtk_window_set_type_hint(GTK_WINDOW(entrydialog),
                             GDK_WINDOW_TYPE_HINT_DIALOG);
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(entrydialog), cancelbutton2,
                                 GTK_RESPONSE_CANCEL);
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(entrydialog), okbutton2,
                                 GTK_RESPONSE_OK);
    ...
    GLADE_HOOKUP_OBJECT_NO_REF(entrydialog, dialog_action_area3,
                               "dialog_action_area3");
...
GtkWidget *create_addlocationdlg(void) {
    ...
    gtk_window_set_type_hint(GTK_WINDOW(addlocationdlg),
                             GDK_WINDOW_TYPE_HINT_DIALOG);
    ...
    addlocation_actionarea =
        gtk_dialog_get_action_area(GTK_DIALOG(addlocationdlg));
    gtk_widget_show(addlocation_actionarea);
    gtk_button_box_set_layout(GTK_BUTTON_BOX(addlocation_actionarea),
                              GTK_BUTTONBOX_END);

    cancelbutton3 = gtk_button_new();
    gtk_widget_show(cancelbutton3);
    gtk_dialog_add_action_widget(GTK_DIALOG(addlocationdlg), cancelbutton3,
                                 GTK_RESPONSE_CANCEL);
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(addlocationdlg), okbutton3,
                                 GTK_RESPONSE_OK);
    ...
    GLADE_HOOKUP_OBJECT_NO_REF(addlocationdlg, addlocation_actionarea,
                               "addlocation_actionarea");
...
GtkWidget *create_groupbydlg(void) {
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(groupbydlg), cancelbutton4,
                                 GTK_RESPONSE_CANCEL);
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(groupbydlg), okbutton4,
                                 GTK_RESPONSE_OK);
    ...
    GLADE_HOOKUP_OBJECT_NO_REF(groupbydlg, dialog_action_area4,
                               "dialog_action_area4");
...
GtkWidget *create_sortbydlg(void) {
    ...
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(sortorder),
                                   _("Descending"));
    ...
    GLADE_HOOKUP_OBJECT_NO_REF(sortbydlg, dialog_action_area7,
                               "dialog_action_area7");
...
GtkWidget *create_select_dsp_plugin(void) {
    ...
    gtk_window_set_type_hint(GTK_WINDOW(select_dsp_plugin),
                             GDK_WINDOW_TYPE_HINT_DIALOG);
    ...
    dialog_action_area9 =
        gtk_dialog_get_action_area(GTK_DIALOG(select_dsp_plugin));
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(select_dsp_plugin), cancelbutton7,
                                 GTK_RESPONSE_CANCEL);
    gtk_widget_set_can_default(cancelbutton7, TRUE);

    okbutton7 = gtk_button_new_from_stock("gtk-ok");
    gtk_widget_show(okbutton7);
    gtk_dialog_add_action_widget(GTK_DIALOG(select_dsp_plugin), okbutton7,
                                 GTK_RESPONSE_OK);
    gtk_widget_set_can_default(okbutton7, TRUE);

    /* Store pointers to all widgets, for use by lookup_widget(). */
    GLADE_HOOKUP_OBJECT_NO_REF(select_dsp_plugin, select_dsp_plugin,
                               "select_dsp_plugin");
    ...
    GLADE_HOOKUP_OBJECT_NO_REF(select_dsp_plugin, dialog_action_area9,
                               "dialog_action_area9");
...
GtkWidget *create_tagwritersettings(void) {
    ...
    gtk_window_set_type_hint(GTK_WINDOW(tagwritersettings),
                             GDK_WINDOW_TYPE_HINT_DIALOG);
    ...
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(id3v2_version),
                                   _("2.3 (Recommended)"));
    ...
    label119 =
        gtk_label_new(_("ID3v1 character encoding (default is iso8859-1)"));
    ...
    dialog_action_area10 =
        gtk_dialog_get_action_area(GTK_DIALOG(tagwritersettings));
    ...
    GLADE_HOOKUP_OBJECT_NO_REF(tagwritersettings, dialog_action_area10,
                               "dialog_action_area10");
...
GtkWidget *create_ctmappingdlg(void) {
    ...
    gtk_window_set_type_hint(GTK_WINDOW(ctmappingdlg),
                             GDK_WINDOW_TYPE_HINT_DIALOG);
    ...
    gtk_text_buffer_set_text(
        ...
        _("This table defines the binding between network stream content types "
          "and DeaDBeeF decoder plugins. For example, mp3 files can have content "
          "type \"audio/x-mpeg\", and need to be decoded by DeaDBeeF's own "
          "\"stdmpg\" plugin, or \"ffmpeg\" plugin."),
        -1);
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(ctmappingdlg), ctmapping_apply,
                                 GTK_RESPONSE_APPLY);
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(ctmappingdlg), ctmapping_cancel,
                                 GTK_RESPONSE_CANCEL);
    ...
    GLADE_HOOKUP_OBJECT_NO_REF(ctmappingdlg, dialog_action_area11,
                               "dialog_action_area11");
...
GtkWidget *create_ctmappingeditdlg(void) {
    ...
    gtk_window_set_title(GTK_WINDOW(ctmappingeditdlg),
                         _("Edit Content-Type Mapping"));
    gtk_window_set_modal(GTK_WINDOW(ctmappingeditdlg), TRUE);
    gtk_window_set_type_hint(GTK_WINDOW(ctmappingeditdlg),
                             GDK_WINDOW_TYPE_HINT_DIALOG);
    ...
    dialog_action_area12 =
        gtk_dialog_get_action_area(GTK_DIALOG(ctmappingeditdlg));
    gtk_widget_show(dialog_action_area12);
    gtk_button_box_set_layout(GTK_BUTTON_BOX(dialog_action_area12),
                              GTK_BUTTONBOX_END);

    cancelbutton8 = gtk_button_new_from_stock("gtk-cancel");
    gtk_widget_show(cancelbutton8);
    gtk_dialog_add_action_widget(GTK_DIALOG(ctmappingeditdlg), cancelbutton8,
                                 GTK_RESPONSE_CANCEL);
    gtk_widget_set_can_default(cancelbutton8, TRUE);

    okbutton8 = gtk_button_new_from_stock("gtk-ok");
    gtk_widget_show(okbutton8);
    gtk_dialog_add_action_widget(GTK_DIALOG(ctmappingeditdlg), okbutton8,
                                 GTK_RESPONSE_OK);
    gtk_widget_set_can_default(okbutton8, TRUE);

    /* Store pointers to all widgets, for use by lookup_widget(). */
    GLADE_HOOKUP_OBJECT_NO_REF(ctmappingeditdlg, ctmappingeditdlg,
                               "ctmappingeditdlg");
    ...
    GLADE_HOOKUP_OBJECT_NO_REF(ctmappingeditdlg, dialog_action_area12,
                               "dialog_action_area12");
...
GtkWidget *create_button_properties(void) {
    ...
    gtk_window_set_type_hint(GTK_WINDOW(button_properties),
                             GDK_WINDOW_TYPE_HINT_DIALOG);
    ...
    dialog_action_area13 =
        gtk_dialog_get_action_area(GTK_DIALOG(button_properties));
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(button_properties), applybutton1,
                                 GTK_RESPONSE_APPLY);
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(button_properties), cancelbutton9,
                                 GTK_RESPONSE_CANCEL);
    gtk_widget_set_can_default(cancelbutton9, TRUE);

    okbutton9 = gtk_button_new_from_stock("gtk-ok");
    gtk_widget_show(okbutton9);
    gtk_dialog_add_action_widget(GTK_DIALOG(button_properties), okbutton9,
                                 GTK_RESPONSE_OK);
    gtk_widget_set_can_default(okbutton9, TRUE);

    /* Store pointers to all widgets, for use by lookup_widget(). */
    GLADE_HOOKUP_OBJECT_NO_REF(button_properties, button_properties,
                               "button_properties");
    ...
    GLADE_HOOKUP_OBJECT_NO_REF(button_properties, dialog_action_area13,
                               "dialog_action_area13");
...
GtkWidget *create_select_action(void) {
    ...
    gtk_window_set_type_hint(GTK_WINDOW(select_action),
                             GDK_WINDOW_TYPE_HINT_DIALOG);
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(select_action), cancelbutton10,
                                 GTK_RESPONSE_CANCEL);
    gtk_widget_set_can_default(cancelbutton10, TRUE);

    okbutton10 = gtk_button_new_from_stock("gtk-ok");
    gtk_widget_show(okbutton10);
    gtk_dialog_add_action_widget(GTK_DIALOG(select_action), okbutton10,
                                 GTK_RESPONSE_OK);
    ...
    GLADE_HOOKUP_OBJECT_NO_REF(select_action, dialog_action_area14,
...
GtkWidget *create_setcustomtitledlg(void) {
    ...
    gtk_window_set_type_hint(GTK_WINDOW(setcustomtitledlg),
                             GDK_WINDOW_TYPE_HINT_DIALOG);
    ...
    gtk_text_buffer_set_text(
        ...
        _("This dialog allows setting custom title for any track. This is most "
          "useful for radio stations. An option to set the custom title is also "
          "present in the \"Add Location\" dialog. The title itself is visible "
          "in columns displaying the \"Artist\" metadata field. It should look "
          "like \"[custom] artist\" if the Artist field is present, or just "
          "\"custom\" otherwise."),
        -1);
    ...
    dialog_action_area15 =
        gtk_dialog_get_action_area(GTK_DIALOG(setcustomtitledlg));
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(setcustomtitledlg), cancelbutton11,
                                 GTK_RESPONSE_CANCEL);
    gtk_widget_set_can_default(cancelbutton11, TRUE);

    okbutton11 = gtk_button_new_from_stock("gtk-ok");
    gtk_widget_show(okbutton11);
    gtk_dialog_add_action_widget(GTK_DIALOG(setcustomtitledlg), okbutton11,
                                 GTK_RESPONSE_OK);
    gtk_widget_set_can_default(okbutton11, TRUE);

    /* Store pointers to all widgets, for use by lookup_widget(). */
    GLADE_HOOKUP_OBJECT_NO_REF(setcustomtitledlg, setcustomtitledlg,
                               "setcustomtitledlg");
    ...
    GLADE_HOOKUP_OBJECT_NO_REF(setcustomtitledlg, dialog_action_area15,
                               "dialog_action_area15");
...
GtkWidget *create_trkproperties_popup_menu(void) {
    ...
    gtk_container_add(GTK_CONTAINER(trkproperties_popup_menu),
                      trkproperties_edit);

    trkproperties_edit_in_place =
        gtk_menu_item_new_with_mnemonic(_("Edit (in place)"));
    ...
    trkproperties_add_new_field =
        gtk_menu_item_new_with_mnemonic(_("Add new field..."));
    gtk_widget_show(trkproperties_add_new_field);
    gtk_container_add(GTK_CONTAINER(trkproperties_popup_menu),
                      trkproperties_add_new_field);

    g_signal_connect((gpointer)trkproperties_edit, "activate",
                     G_CALLBACK(on_trkproperties_edit_activate), NULL);
    g_signal_connect((gpointer)trkproperties_edit_in_place, "activate",
                     G_CALLBACK(on_trkproperties_edit_in_place_activate), NULL);
    g_signal_connect((gpointer)trkproperties_remove, "activate",
                     G_CALLBACK(on_trkproperties_remove_activate), NULL);
    g_signal_connect((gpointer)trkproperties_crop, "activate",
                     G_CALLBACK(on_trkproperties_crop_activate), NULL);
    g_signal_connect((gpointer)trkproperties_add_new_field, "activate",
                     G_CALLBACK(on_trkproperties_add_new_field_activate), NULL);

    /* Store pointers to all widgets, for use by lookup_widget(). */
    GLADE_HOOKUP_OBJECT_NO_REF(trkproperties_popup_menu, trkproperties_popup_menu,
                               "trkproperties_popup_menu");
    GLADE_HOOKUP_OBJECT(trkproperties_popup_menu, trkproperties_edit,
                        "trkproperties_edit");
    GLADE_HOOKUP_OBJECT(trkproperties_popup_menu, trkproperties_edit_in_place,
                        "trkproperties_edit_in_place");
    GLADE_HOOKUP_OBJECT(trkproperties_popup_menu, trkproperties_remove,
                        "trkproperties_remove");
    GLADE_HOOKUP_OBJECT(trkproperties_popup_menu, trkproperties_crop,
                        "trkproperties_crop");
    GLADE_HOOKUP_OBJECT(trkproperties_popup_menu, trkproperties_add_new_field,
                        "trkproperties_add_new_field");
...
GtkWidget *create_edit_tag_value_dlg(void) {
    ...
    gtk_window_set_type_hint(GTK_WINDOW(edit_tag_value_dlg),
                             GDK_WINDOW_TYPE_HINT_DIALOG);
    ...
    dialog_action_area16 =
        gtk_dialog_get_action_area(GTK_DIALOG(edit_tag_value_dlg));
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(edit_tag_value_dlg), cancelbutton12,
                                 GTK_RESPONSE_CANCEL);
    gtk_widget_set_can_default(cancelbutton12, TRUE);

    okbutton12 = gtk_button_new_from_stock("gtk-ok");
    gtk_widget_show(okbutton12);
    gtk_dialog_add_action_widget(GTK_DIALOG(edit_tag_value_dlg), okbutton12,
                                 GTK_RESPONSE_OK);
    gtk_widget_set_can_default(okbutton12, TRUE);

    /* Store pointers to all widgets, for use by lookup_widget(). */
    GLADE_HOOKUP_OBJECT_NO_REF(edit_tag_value_dlg, edit_tag_value_dlg,
                               "edit_tag_value_dlg");
    GLADE_HOOKUP_OBJECT_NO_REF(edit_tag_value_dlg, dialog_vbox17,
                               "dialog_vbox17");
    ...
    GLADE_HOOKUP_OBJECT_NO_REF(edit_tag_value_dlg, dialog_action_area16,
                               "dialog_action_area16");
...
GtkWidget *create_log_window(void) {
    ...
    g_signal_connect((gpointer)log_window, "key_press_event",
                     G_CALLBACK(on_log_window_key_press_event), NULL);
    g_signal_connect((gpointer)log_clear, "clicked",
                     G_CALLBACK(on_log_clear_clicked), NULL);
...
GtkWidget *create_rg_scan_progress(void) {
    ...
    gtk_window_set_title(GTK_WINDOW(rg_scan_progress),
                         _("ReplayGain Scan Progress"));
    ...
    gtk_label_set_ellipsize(GTK_LABEL(rg_scan_progress_status),
                            PANGO_ELLIPSIZE_END);
    ...
    gtk_box_pack_start(GTK_BOX(hbox143), rg_scan_progress_cancel, FALSE, FALSE,
                       0);

    /* Store pointers to all widgets, for use by lookup_widget(). */
    GLADE_HOOKUP_OBJECT_NO_REF(rg_scan_progress, rg_scan_progress,
                               "rg_scan_progress");
    ...
    GLADE_HOOKUP_OBJECT(rg_scan_progress, rg_scan_progress_file,
                        "rg_scan_progress_file");
    GLADE_HOOKUP_OBJECT(rg_scan_progress, rg_scan_progress_bar,
                        "rg_scan_progress_bar");
    GLADE_HOOKUP_OBJECT(rg_scan_progress, hbox143, "hbox143");
    GLADE_HOOKUP_OBJECT(rg_scan_progress, rg_scan_progress_status,
                        "rg_scan_progress_status");
    GLADE_HOOKUP_OBJECT(rg_scan_progress, rg_scan_progress_cancel,
                        "rg_scan_progress_cancel");
...
GtkWidget *create_rg_scan_results(void) {
    ...
    gtk_window_set_title(GTK_WINDOW(rg_scan_results),
                         _("ReplayGain Scan Results"));
    ...
    gtk_label_set_ellipsize(GTK_LABEL(rg_scan_results_status),
                            PANGO_ELLIPSIZE_END);
    ...
    /* Store pointers to all widgets, for use by lookup_widget(). */
    GLADE_HOOKUP_OBJECT_NO_REF(rg_scan_results, rg_scan_results,
                               "rg_scan_results");
    GLADE_HOOKUP_OBJECT(rg_scan_results, vbox51, "vbox51");
    GLADE_HOOKUP_OBJECT(rg_scan_results, scrolledwindow15, "scrolledwindow15");
    GLADE_HOOKUP_OBJECT(rg_scan_results, rg_scan_results_list,
                        "rg_scan_results_list");
    GLADE_HOOKUP_OBJECT(rg_scan_results, hbox144, "hbox144");
    GLADE_HOOKUP_OBJECT(rg_scan_results, rg_scan_results_status,
                        "rg_scan_results_status");
    GLADE_HOOKUP_OBJECT(rg_scan_results, rg_scan_results_update,
                        "rg_scan_results_update");
    GLADE_HOOKUP_OBJECT(rg_scan_results, rg_scan_results_cancel,
                        "rg_scan_results_cancel");
