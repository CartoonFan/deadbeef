...
// Most of these values come from Elio's port, these values should be checked if
...
// rename replacement which works with UTF-8 strings and when using as atomic
// write
#undef rename
...
int scandir(const char *__dir, struct dirent ***__namelist,
