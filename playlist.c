...
int pl_add_files_begin(playlist_t *plt) {
...
int plt_get_item_count(playlist_t *plt, int iter) {
...
int pl_get_idx_of(playItem_t *it) {
...
float pl_get_item_duration(playItem_t *it) {
    return it->_duration;
}
...
int pl_is_selected(playItem_t *it) {
    return it->selected;
}
...
int plt_is_fast_mode(playlist_t *plt) {
...
void plt_set_scroll(playlist_t *plt, int scroll) {
    plt->scroll = scroll;
}

int plt_get_scroll(playlist_t *plt) {
    return plt->scroll;
}
...
int plt_is_loading_cue(playlist_t *plt) {
