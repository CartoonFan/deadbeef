...
- (void)testSimpleDownsamplerBufSizeFrom192To48 {
    ...
    int res = dsp_apply_simple_downsampler(192000, 2, input, sizeof(input), 48000,
                                           &out_buf, &out_size);

    XCTAssert(res == sizeof(input), @"The actual output is: %d", res);
    XCTAssert(out_size == sizeof(input) / 4, @"The actual output is: %d",
              out_size);
}
...
- (void)testSimpleDownsamplerBufSizeFrom96To48 {
    ...
    int res = dsp_apply_simple_downsampler(96000, 2, input, sizeof(input), 48000,
                                           &out_buf, &out_size);

    XCTAssert(res == sizeof(input), @"The actual output is: %d", res);
    XCTAssert(out_size == sizeof(input) / 2, @"The actual output is: %d",
              out_size);
}
...
- (void)testSimpleDownsamplerInvalid32To48 {
    ...
    int res = dsp_apply_simple_downsampler(32000, 2, input, sizeof(input), 48000,
                                           &out_buf, &out_size);
...
- (void)testSimpleDownsamplerInvalid50To48 {
    ...
    int res = dsp_apply_simple_downsampler(50000, 2, input, sizeof(input), 48000,
                                           &out_buf, &out_size);
...
- (void)testSimpleDownsampler96To48NonMultiple {
    ...
    int res = dsp_apply_simple_downsampler(96000, 2, input, (int)sizeof(input),
                                           48000, &out_buf, &out_size);
...
- (void)testSimpleDownsampler192To48NonMultiple {
    ...
    int res = dsp_apply_simple_downsampler(192000, 2, input, (int)sizeof(input),
                                           48000, &out_buf, &out_size);
...
- (void)testSimpleDownsamplerOutputBufSizeFrom192To48 {
    ...
    int res = dsp_apply_simple_downsampler(
                  192000, 1, (char *)input, sizeof(input), 48000, &out_buf, &out_size);

    XCTAssert(res == 8);
    XCTAssert(out_size == 2);
    XCTAssert(((short *)out_buf)[0] == 0x3fff, @"The actual output is: %d",
              (int)((short *)out_buf)[0]);
}
...
- (void)testSimpleDownsamplerOutputBufSizeFrom96To48 {
    ...
    int res = dsp_apply_simple_downsampler(96000, 1, (char *)input, sizeof(input),
                                           48000, &out_buf, &out_size);
